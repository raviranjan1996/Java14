...
//	private static Color foregroudColor = Color.GREEN;
	...
	public GamePanel() {
		...
		Executors.newScheduledThreadPool(1).scheduleAtFixedRate(()-> next(),200, 200, TimeUnit.MILLISECONDS);
	...
	public void save(File selectedFile) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Cannot Save File" , "Error Occured", JOptionPane.ERROR_MESSAGE);
	...
	public void open(File selectedFile) {
		try {
			...
			JOptionPane.showMessageDialog(this, "Cannot open File" , "Error Occured", JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
